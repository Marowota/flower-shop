...
export default function HomeStats() {
  ...
  function ordersTotal(orders) {
    ...
    return new Intl.NumberFormat("vn-VN").format(sum);
  }
  ...
  return (
    <div>
      ...
      <div className="tiles-grid">
        <div className="tile">
          <h3 className="tile-header">Today</h3>
          <div className="tile-number">{ordersTotal(ordersToday)} VND</div>
          <div className="tile-desc">{ordersToday.length} orders today</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">This week</h3>
          <div className="tile-number">{ordersTotal(ordersWeek)} VND</div>
          <div className="tile-desc">{ordersWeek.length} orders this week</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">This month</h3>
          <div className="tile-number">{ordersTotal(ordersMonth)} VND</div>
          <div className="tile-desc">
            {ordersMonth.length} orders this month
          </div>
        </div>
